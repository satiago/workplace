...
if(isset($_POST["submit"])){
  if(mysql_query("update tb_replyword set title='".$_POST["title"]."',content='".$_POST["content"]."' where id='".$_POST["id"]."'",$conn)){
...
<table width="550" height="200" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FCD424">
 ...
 <form name="form1" method="post" action="editreplyword.php" onSubmit="return chkinput(this)">
  ...
  <tr>
    <td height="25" colspan="2" bgcolor="#FFFFFF"><div align="center">
      ...
      <input type="submit" value="编辑" class="buttoncss" name="submit">&nbsp;&nbsp;<input type="reset" value="取消" class="buttoncss"></div></td>
  </tr>
  </form>
