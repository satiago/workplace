...
if(isset($_SESSION["unc"])){        //对登录用户进行判断
	$sql=mysql_query("select id from tb_user where username='".$_SESSION["unc"]."'");   //查询当前用户数据表中的信息
...
if(isset($_POST['content'])){
	...
	if(mysql_query("insert into tb_leaveword(userid,createtime,title,content) values('$userid','$createtime','".$_POST['title']."','".$_POST['content']."')")){ 
